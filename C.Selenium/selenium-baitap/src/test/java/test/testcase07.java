...
public class testcase07 {
    public static void testcase07() {
        /*Chức năng xuat file PDF sản phẩm đã đặt
            B1: vào trang web Yame
            B2. vào gu tối giản
            B2.1: chọn sản phẩm thêm vào giỏ hàng
            B3 quay ra
            B3.1 chọn sản phẩm thêm vào giỏ hàng
...
//            codeOTP.sendKeys("000000");
            ...
            //5. vào gu tối giản
            WebElement Page1 = driver.findElement(By.xpath("//ul[@class='site-menu js-clone-nav d-none d-lg-block']//a[contains(text(),'GU TỐI GIẢN')]"));
            Page1.click();
            Thread.sleep(5500);

            //5.1 chọn sản phẩm thêm vào giỏ hàng
            ...
            //6 quay ra
            WebElement Page2 = driver.findElement(By.xpath("//i[@class='fa fa-chevron-left']"));
            Page2.click();
            Thread.sleep(5500);

            //6.1 chọn sản phẩm thêm vào giỏ hàng
            WebElement product2 = driver.findElement(By.xpath("//body/div[@class='site-wrap']/div[@class='container-fluid mb-4']/div[3]/div[2]/div[1]/div[1]/div[1]/div[1]/div[2]/a[1]/img[1]"));
            product2.click();
            Thread.sleep(3000);

            //nhấn thêm
            WebElement Addtocart2 = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[3]/div[2]/div[2]/div[1]/div[1]/div[1]/table[1]/tbody[1]/tr[1]/td[3]/form[1]/a[1]"));
            Addtocart2.click();
            Thread.sleep(3000);
...
// Tạo tài liệu PDF
            ...
            PdfWriter.getInstance(document, new FileOutputStream(".\\src\\test\\java\\test\\orders.pdf"));
            document.open();

// Thêm tiêu đề và tác giả
            document.addTitle("Orders");
            document.addCreator("Orders");

// Tìm bảng chứa thông tin đơn hàng
            WebElement ordersTable = driver.findElement(By.className("table"));

// Tạo bảng trong tài liệu PDF và thêm thông tin đơn hàng
            PdfPTable pdfTable = new PdfPTable(4);
            pdfTable.setWidthPercentage(100);
            pdfTable.addCell("Sản phẩm");
